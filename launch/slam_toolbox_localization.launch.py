...
def generate_launch_description():
    ...
    # Start SLAM Toolbox with configurable mode and map file
    # The order of parameters is important - later ones override earlier ones
    start_slam_toolbox_node = Node(
        parameters=[
          # First load the base params file
          slam_params_file,
